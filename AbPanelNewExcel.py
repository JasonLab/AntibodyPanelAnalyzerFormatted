...
if TMQ_9[
    'D'] == '+' and TMQ_9_Res == '0' and 'D' in Possible_Antigen:  # The in Possible_Antigen prevents an error when the program tries to delete non existent D.. need to find a better way to do this.
    del Possible_Antigen['D']
    # print(Possible_Antigen)
...
if TMQ_9['Fyb'] == '+' and TMQ_9['Fya'] == '0' and TMQ_9_Res == '0' and 'Fyb' in Possible_Antigen:
    ...
    # print(Possible_Antigen)
if TMQ_9[
    'Lea'] == '+' and TMQ_9_Res == '0' and 'Lea' in Possible_Antigen:  # and TMQ_9['Leb'] == '0' May want to add this depending on rules used
    del Possible_Antigen['Lea']
    # print(Possible_Antigen)
if TMQ_9[
    'Leb'] == '+' and TMQ_9_Res == '0' and 'Leb' in Possible_Antigen:  # and TMQ_9['Lea'] == '0'  May want to add this depending on rules used
    del Possible_Antigen['Leb']
    # print(Possible_Antigen)
